        ...
        <form>
            ...
            <fieldset>
                <label htmlFor="newProductType"> Product Type
                    <select required id="newProductType" name="productTypeId" onChange={handleUserInputSelect}>
                        ...
                        {productTypes.map(
                            (productType) => {
                                return (<option key={productType.id} value={productType.id} >{productType.type}</option>)
                            }
                        )
                        }
                    </select>
            ...
            <fieldset>
                <label htmlFor="newProductPrice">Price
                    <input type="number" required id="newProductPrice" name="unitPrice" value={userChoices.unitPrice} onChange={handleUserInputPrice} />
                </label>
            </fieldset>
